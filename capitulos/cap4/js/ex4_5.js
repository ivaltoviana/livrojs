...
function registrarContas() {
  ...
  // varifica preenchimento dos campos
  ...
  // contador para apresentar a cada acréscimo de conta o número de contas insridas
  numContas++
  // acumulador para somar o valor das contas inseridas
